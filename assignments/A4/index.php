...
<!--
                ...
                <div id="conduct" class="sidenav-anchor">
                    ...
                    <p>Make things easy for your evaluator by printing a sheet of Nielsen's heuristics. Prepare a sheet for them to fill out while evaluating. (Try using <a href="../../HeuristicWorksheet.pdf" target="_blank">this worksheet</a>.) A good idea is to set up a spreadsheet on a laptop that you and the evaluator can share. (This spreadsheet makes it easy for the evaluator to do his assignment and for you to improve the design.) Remember that the evaluator is the expert. Let them explore and evaluate the interface as they choose, but make sure that they go over each of your two proposed prototypes.</p>
                </div>
                ...
                <div id="examples" class="sidenav-anchor">
                    ...
                    <p><a href="http://hci.stanford.edu/courses/cs147/2014/assignments/examples/pdfs/a04e1.pdf">Example 1</a> - This student did an incredibly thorough heuristic evaluation. We especially like how this student incorporated comparative feedback. Keep in mind that the this assignment was slightly different last year.</p>
                </div>
