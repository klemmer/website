...
<html>
  <head>
    ...
    <title>Intro to HCI: Assignment 10</title>
            ...
            <div class="col-md-9" id="assignment-description">
                ...
                <div id="submit" class="sidenav-anchor">
                    ...
                    <ul>
                        ...
                        <li>A zipped file of your code (for archival/educational purposes).</li>
                        <li>Slide: 1 JPG file, 1024x768 showing your interface. No audio or animation. 30 seconds only. After 30 seconds, it will automatically advance to the next group's slide.</li>
                        <li>An electronic version of your poster or photos of it online. Posters will be hung on the wall. Your poster will be 24" wide and 30" high. People will view your poster from both far away and up close. If you show photos, make sure everything is visible and legible.</li>
                    </ul>
                ...
                <div id="examples" class="sidenav-anchor">
                    ...
                    <p><a href="./examples/a10examples.html" target="_blank">Here are several student examples of slides and posters from previous years.</a></p>
                </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>The Pitch/Poster/Demo don't clearly articulate a user need.</td>
                                ...
                                <tr>
                                    ...
                                    <td>The Pitch/Poster/Demo don't clearly articulate a point of view.</td>
                                    <td>It's not clear what's unique about this prototype.</td>
                                ...
                                <tr>
                                    <td headers="guiding" colspan=2><br>Outside the Box<br><span style="color:lightGray;"><span style="color:lightGray;">2 points. Up to 5% of submissions.</span></td>
                ...
                <div id='self-assessment' class='sidenav-anchor' style='margin-top: 20px'>
                    <h2>Evaluations</h2>
                    <p>
                        <a href="https://docs.google.com/forms/d/1vNHBVxjdorX34qNe9UwsvzRrLIfspgz-Q2_s0j9eNbw/viewform">During studio, click here to assess your group's work as a collective unit.</a></br>
                        <a href="https://docs.google.com/forms/d/1IVeHqfGPLJVCDn3zzqkaJEFV5fFCtC6cDtEwGGiK6UU/viewform"> During studio, click here to assess your own work and each of your team member's work.</a></br>
                        <a href="https://docs.google.com/forms/d/1KLshlyiujxSSbykhcbSD0aYlcjWd3TgetFATYagWmP4/viewform"> During studio, click here to evaluate the Intro HCI Class.</a></br>
                        <a href=" https://docs.google.com/forms/d/1WgRDAJ6REfDXZYBSC6yHlLEJ5h-n0z-TaZKk07Gv76s/viewform"> During studio, click here to give your views about learning.</a></br>
                    </p>
                </div>
            </div>
        </div>
