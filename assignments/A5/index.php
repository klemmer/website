        ...
        <div class="row">
            ...
            <div class="col-md-9" id="assignment-description">
                ...
                <div id="createlinks" class="sidenav-anchor">
                    <h4>Create a Home Screen &amp; Key Links</h4>
                    <p>Create a home screen with a full set of navigational links, and flesh out two additional major screens. The remaining screens can be placeholders; the goal is to get a navigational skeleton up there that someone can click around and get a good feel of the application's flow. Make sure that if you have a button or icon, it links to something, whether it’s an implemented page or simply a holding page. You will fill in the blanks and flesh out the details later. You're of course welcome to get more done this week.</p>
                    <p>You can use the HTML, CSS, Bootstrap, and Javascript skills you've learned in lab. You're also welcome to design your screens graphically; we recommend <a href="https://webflow.com" target="_blank">Webflow</a>. Say, for example, your project was this course site. For A5, you might mak the home page, the submission page, and the logistics page. For A5, You could have empty, dummy stub pages for the other things that the nav links to. You'll flesh those out in A6/7. Using your lab skills, share your project through github so that everyone can access it.</p>
                </div>
                ...
                <div id="thinkingahead" class="sidenav-anchor">
                    <h4>Looking Ahead</h4>
                    <p>We know that many of you have midterms or major projects this week, so this week's assignment is lighter than the next two. We <b>strongly</b> encourage you to use this time to start working on the functionality of your prototype. It is in your own best interests to get started on the functionality as soon as possible.</p>
                </div>
                ...
                <div id="submit" class="sidenav-anchor">
                    <h2>Submit</h2>
                    <ul>
                        <li>List of changes you are making to your prototype. <b>(List of Changes)</b></li>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>The student only identified a few changes from the heuristic evaluation feedback and a large amount of feedback is ignored in the prototype; the changes would introduce some HE violations.</td>
                                    <td>Many of the simpler suggested changes were made, but some of the more complex or difficult issues were not addressed; the changes would not introduce any obvious HE violations.</td>
                ...
                <div id='self-assessment' class='sidenav-anchor' style='margin-top: 20px'>
                    ...
                    <p>
                        <a class='btn btn-primary' target='_blank' href="./week%206%20group%20assessment.html">During studio, click here to assess your group's work as a collective unit.</a>
                        </br>
                        <a style="margin-top: 10px;" class='btn btn-primary' href="https://docs.google.com/forms/d/1t13z6-s7ZXKdGPhU9Fez3TZuXzBdFAnekJ0Xr4fFJpw/viewform"> During studio, click here to assess your own work and each of your team member's work.</a>
                    </p>
                </div>
            ...
            <footer>
        This course was created by <a href='http://d.ucsd.edu/srk'>Scott Klemmer</a>, and revised in collaboration with <a href='http://hci.stanford.edu/msb'>Michael Bernstein</a>, and our teaching staffs. Instructors: you are welcome to use these materials for your own class, and dozens of courses around the world do. We share all course materials <a href=
https://creativecommons.org/licenses/by/4.0/deed.en_US
>through a CC-BY license</a>. Please let Scott know if you use them, and also any suggestions you have. We thank <a href=http://www.calit2.net/>CalIT2</a> and the <a href=http://www.jacobsschool.ucsd.edu/moxiecenter>Moxie Center</a> for helping support our studios.
    </footer>
